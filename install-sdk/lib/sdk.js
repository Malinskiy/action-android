...
class BaseAndroidSdk {
    ...
    install(url, cmdlineToolsVersion) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, exec_with_result_1.execIgnoreFailure)(`bash -c \\\"${this.androidHome()}/cmdline-tools/bootstrap-version/bin/sdkmanager 'cmdline-tools;${cmdlineToolsVersion}'`);
            return true;
        });
    }
    androidHome() {
    ...
    installEmulatorPackage(api, tag, abi, verbose, cmdlineToolsVersion) {
        return __awaiter(this, void 0, void 0, function* () {
            let args = "";
            if (!verbose) {
                args += " > /dev/null";
            }
            yield (0, exec_with_result_1.execIgnoreFailure)(`bash -c \\\"${this.androidHome()}/cmdline-tools/bootstrap-version/bin/sdkmanager emulator 'cmdline-tools;${cmdlineToolsVersion}' platform-tools 'system-images;android-${api};${tag};${abi}'${args}"`);
        });
    }
